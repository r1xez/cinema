...
namespace cinema
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            cinema.AddGenre(g1); cinema.AddGenre(g2);
            ...
            cinema.AddHall(hall1); cinema.AddHall(hall2);
           ...
           var st1 = cinema.ScheduleShow(1, 1, DateTime.Today.AddHours(14), 120m, "EN", "UA");
            ...
            staff.StartShift("Morning");
            staff.AssignTask("Check projector");
            cinema.StaffMembers.Add(staff);

           
            var availableSeats = st1.GetAvailableSeats().Take(2).Select(s => s.Id).ToList();
